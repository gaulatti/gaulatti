          ...
          <div className="grid items-center gap-12 md:grid-cols-2">
            <div>
              ...
              <p className="light:text-gray-600 dark:text-text-secondary mb-6 text-lg">
                Executive production and live operations leadership for a joint
                media venture covering the Sanremo Festival. Includes crisis
                response, production redesign, editorial direction, and
                multi-hour live broadcasts from Italy.
              </p>
              <div className="mb-8 flex flex-wrap gap-4">
                <div className="flex items-center gap-2">
                  <span className="bg-accent-blue h-2 w-2 rounded-full" />
                  <span className="light:text-gray-600 dark:text-text-secondary text-sm">
                    3 countries coordinated
                  </span>
                </div>
                <div className="flex items-center gap-2">
              ...
              <Link
                to="/sanremo"
                className="text-accent-blue inline-flex items-center gap-2 font-medium hover:underline"
              >
                Read the case study
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="light:text-gray-600 dark:text-text-secondary text-sm">
                      Removed failing dependency and assumed full operational
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="light:text-gray-600 dark:text-text-secondary text-sm">
                      Rebuilt broadcast architecture locally in approximately 3
                      days.
                    </p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="light:text-gray-600 dark:text-text-secondary text-sm">
                      Led multi-hour broadcasts with distributed contributors
                      across time zones.
                    </p>
                  </div>
                </div>
