  ...
  return (
    <footer className="bg-deep-sea dark:bg-sand text-white">
      ...
      <div className="container mx-auto px-4 py-20">
                ...
                <li key={social.label}>
                  ...
                  >
                    {social.iconComponent ? (
                      <social.iconComponent className="h-5 w-5 opacity-80 transition-opacity duration-400 group-hover:opacity-100" />
                    ) : (
                      <img
                        src={social.icon}
                        alt={social.label}
        ...
        <div className="light:border-sand/10 dark:border-dark-sand/60 mt-20 flex flex-col items-center justify-between border-t pt-8 md:flex-row">
          <div className="tracking-refined light:text-sand/60 dark:text-text-secondary text-sm">
