...
export const featuredItems: HeroItem[] = [
  {
    ...
    description:
      "From Normandy to product launches: why speed, not polish, wins the first battle..",
  ...
  },
  {
    type: "post",
    title:
      "Alphabetical Acceleration: From Atacama to Zurich, One Sprint at a Time.",
    description:
      "How this simple alphabetic rule turns routine cycles into a motivating narrative and breaks the monotony of sprints.",
  ...
  },
  {
    type: "post",
    title:
      "From Problem to Product: How Nazca turned into Live Streaming for Real-Time Earthquake Monitoring.",
    description:
  ...
  },
  {
    ...
    description:
      "Before we test features, we should be testing ideas. This post explores how design can be a mindset and not just a deliverable.",
