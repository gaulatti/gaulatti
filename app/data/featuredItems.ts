...
export const featuredItems: HeroItem[] = [
  {
    type: 'post',
    title: 'Colombo: How to get a photo from the ground to the newsroom in 15 seconds',
    description:
      'The story behind Colombo — from Sanremo field constraints to a production-ready upload flow that gets photos from camera to editor in seconds.',
    image: '/hero/colombo.avif',
    link: 'https://blog.gaulatti.com/colombo-how-to-get-a-photo-from-the-ground-to-the-newsroom-in-15-seconds-1acf6d0c7005',
    tags: ['Photojournalism', 'Media Infrastructure', 'Live Operations', 'CMS', 'FTP']
  },
  {
    type: 'project',
  ...
  },
  {
    ...
    description: 'Before we test features, we should be testing ideas. This post explores how design can be a mindset and not just a deliverable.',
