      ...
      <section className='relative py-16'>
        <div className='container'>
          <div className='mx-auto max-w-4xl'>
            <h1 className='mb-6 text-4xl font-semibold leading-[1.08] tracking-refined md:text-5xl'>Case Studies</h1>
          ...
          <div className='mx-auto max-w-4xl space-y-10'>
            {/*
              <Link to='/success-cases/fifthbell' className='group block'>
                <div className='content-surface p-10 transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--motion-surface)] ease-premium hover:shadow-lg'>
                  ...
                  <h2 className='mb-4 text-2xl font-semibold tracking-refined md:text-3xl group-hover:underline'>fifthbell Media Systems</h2>
                  ...
                  <div className='mb-8 flex flex-wrap gap-6'>
                    <div className='flex items-center gap-2'>
                      ...
                      <span className='font-secondary text-text-secondary text-sm'>8+ interconnected services</span>
                    </div>
                    <div className='flex items-center gap-2'>
                      <span className='bg-accent-red h-2 w-2 rounded-full' />
                      <span className='font-secondary text-text-secondary text-sm'>Live broadcast infrastructure</span>
                    </div>
                    <div className='flex items-center gap-2'>
                      <span className='bg-accent-yellow h-2 w-2 rounded-full' />
                      <span className='font-secondary text-text-secondary text-sm'>TypeScript, AWS, NestJS</span>
                    </div>
                  </div>
            ...
            */}
            ...
            <Link to='/success-cases/sanremo' className='group block'>
              <div className='content-surface p-10 transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--motion-surface)] ease-premium hover:shadow-lg'>
                ...
                <h2 className='mb-4 text-2xl font-semibold tracking-refined md:text-3xl group-hover:underline'>Sanremo Festival Coverage</h2>
                <p className='font-secondary text-text-secondary mb-6 text-lg'>
                ...
                <div className='mb-8 flex flex-wrap gap-6'>
                  <div className='flex items-center gap-2'>
                    <span className='bg-accent-blue h-2 w-2 rounded-full' />
                    <span className='font-secondary text-text-secondary text-sm'>3 countries coordinated</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <span className='bg-accent-red h-2 w-2 rounded-full' />
                    <span className='font-secondary text-text-secondary text-sm'>4–5 hour broadcasts</span>
                  </div>
                  <div className='flex items-center gap-2'>
                    <span className='bg-accent-yellow h-2 w-2 rounded-full' />
                    <span className='font-secondary text-text-secondary text-sm'>~2,000 peak viewers</span>
                  </div>
                </div>
