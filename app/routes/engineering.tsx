...
export function meta({}: Route.MetaArgs) {
  return [
    { title: "Engineering — Javier Godoy" },
    {
      name: "description",
      content:
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl">
            ...
            <p className="light:text-gray-600 dark:text-text-secondary max-w-3xl text-xl">
              I design, build, and operate production systems. This page
              documents the architecture of FifthBell — a personal media
              infrastructure platform I&apos;ve built to power real-world broadcast
              operations, automated content production, and newsroom monitoring.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="mx-auto max-w-5xl">
            <div className="mb-12">
              ...
              <p className="light:text-gray-600 dark:text-text-secondary max-w-3xl text-lg">
                A collection of interconnected services that form a complete
                media production and distribution platform. These systems have
                been used for live event coverage, automated broadcasting, and
                newsroom operations.
              </p>
            </div>
            ...
            <div className="dark:bg-sand mb-12 rounded-lg bg-white p-8">
              ...
              <div className="rounded border-2 border-dashed border-gray-300 p-8 text-center dark:border-gray-600">
                <p className="dark:text-text-secondary mb-4 text-gray-500">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Publishing Engine & Rendering Pipeline
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Core publishing system that transforms CMS content into static
                  pages and automated video clips.
                </p>
                ...
                <div className="mt-2 flex flex-wrap gap-2">
                  <span className="dark:bg-dark-sand rounded bg-gray-100 px-2 py-1 text-xs">
                    TypeScript
                  </span>
                  <span className="dark:bg-dark-sand rounded bg-gray-100 px-2 py-1 text-xs">
                    NestJS
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Broadcast Overlay Control System
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Professional TV broadcast overlay system with real-time
                  control panel for managing on-air graphics.
                </p>
                <h4 className="mt-6 mb-2 font-bold">Architecture</h4>
                <ul className="dark:text-text-secondary space-y-1 text-sm text-gray-600">
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  OBS Control & Playlist Management
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Control interface for OBS via WebSocket. Manages scenes,
                  transitions, and media playlists.
                </p>
                <h4 className="mt-6 mb-2 font-bold">Architecture</h4>
                <ul className="dark:text-text-secondary space-y-1 text-sm text-gray-600">
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Containerized OBS Streaming Runtime
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Dockerized OBS Studio environment for 24/7 automated streaming
                  to YouTube.
                </p>
                <h4 className="mt-6 mb-2 font-bold">Architecture</h4>
                <ul className="dark:text-text-secondary space-y-1 text-sm text-gray-600">
                  <li>
                    • OBS Studio with obs-websocket (v5) for remote API control
                  </li>
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                <div className="bg-accent-blue mb-6 h-1 w-16" />
                <h3 className="mb-2 text-2xl font-bold">Stronzi</h3>
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Story Template Studio
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Web application for creating and exporting professional social
                ...
                <a
                  href="https://github.com/gaulatti/stronzi"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-accent-blue mt-4 inline-block text-sm hover:underline"
                >
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Global News & Earthquake Monitoring
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Source-agnostic content ingestion and monitoring service with
                  real-time SSE feeds.
                </p>
                <h4 className="mt-6 mb-2 font-bold">Architecture</h4>
                <ul className="dark:text-text-secondary space-y-1 text-sm text-gray-600">
                  ...
                  <li>• Google Gemini AI for content analysis</li>
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="text-sea dark:text-accent-blue mb-4 text-sm font-medium">
                  Stream Routing & Monitoring
                </p>
                <h4 className="mt-6 mb-2 font-bold">Purpose</h4>
                <p className="dark:text-text-secondary text-sm text-gray-600">
                  Central control system for managing multiple displays in a
                  newsroom environment.
                </p>
                <h4 className="mt-6 mb-2 font-bold">Architecture</h4>
                <ul className="dark:text-text-secondary space-y-1 text-sm text-gray-600">
                  <li>
                    • <strong>mattone</strong> — Go backend (Echo + GORM +
                    PostgreSQL)
                  </li>
                  <li>
                    • <strong>pioggia</strong> — Kotlin Android TV client
                    (Jetpack Compose)
                  </li>
                ...
                <div className="mt-4 flex gap-4">
                  ...
                  <a
                    href="https://github.com/gaulatti/pioggia"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-accent-blue text-sm hover:underline"
                  >
        ...
        <div className="container">
          <div className="mx-auto max-w-5xl">
            <div className="mb-12">
              ...
              <p className="light:text-gray-600 dark:text-text-secondary max-w-3xl text-lg">
                The live broadcast architecture used for multi-hour event
                coverage and distributed production workflows.
              </p>
            </div>
            ...
            <div className="dark:bg-sand mb-8 rounded-lg bg-white p-8">
              ...
              <div className="space-y-4">
                <div className="flex flex-wrap items-center gap-4">
                  <div className="bg-accent-blue/10 rounded px-4 py-2 font-medium">
                    Camera
                  </div>
                  ...
                  <span className="text-gray-400">→</span>
                  <div className="bg-accent-red/10 rounded px-4 py-2 font-medium">
                    Alcántara Overlays
                  </div>
                  <span className="text-gray-400">→</span>
                  <div className="bg-accent-yellow/10 rounded px-4 py-2 font-medium">
                    YouTube Live
                  </div>
                </div>
                <div className="mt-4 flex flex-wrap items-center gap-4">
                  <div className="dark:bg-dark-sand rounded bg-gray-100 px-4 py-2">
                    RAI Audio
                  </div>
                  <span className="text-gray-400">→</span>
                  <div className="dark:bg-dark-sand rounded bg-gray-100 px-4 py-2">
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="dark:bg-sand rounded-lg bg-white p-6 text-center">
                <div className="text-sea dark:text-accent-blue mb-2 text-4xl font-bold">
                  4-5h
                </div>
            ...
            <div className="dark:bg-sand mt-8 rounded-lg bg-gray-50 p-6">
              ...
              <ul className="dark:text-text-secondary space-y-2 text-sm text-gray-600">
                <li>
                  • Hosts distributed across Italy and Spain, coordinated via
                  Jitsi
                </li>
                <li>
                  • Live audio ingest from RAI broadcast through Scarlett 2i2
                  audio interface
                </li>
                <li>
                  • Real-time overlay control through Alcántara during live
                  broadcast
                </li>
                <li>
                  • Automated lower thirds and graphics triggered by production
                  cues
                </li>
                <li>
                  • Multi-camera switching with scene transitions managed in OBS
                </li>
              </ul>
            </div>
          </div>
        ...
        <div className="container">
          <div className="mx-auto max-w-5xl">
            <div className="mb-12">
              ...
              <p className="light:text-gray-600 dark:text-text-secondary max-w-3xl text-lg">
                The content delivery architecture that powers static publishing,
                video generation, and social media automation.
              </p>
            </div>
            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="dark:text-text-secondary mb-4 text-sm text-gray-600">
                  Content flows from CMS through Cronkite for static generation,
                  deployed to S3 with CloudFront distribution.
                </p>
                <ul className="dark:text-text-secondary space-y-2 text-sm text-gray-600">
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="dark:text-text-secondary mb-4 text-sm text-gray-600">
                  Automated generation of short-form video content from text
                  articles and data feeds.
                </p>
                <ul className="dark:text-text-secondary space-y-2 text-sm text-gray-600">
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="dark:text-text-secondary mb-4 text-sm text-gray-600">
                  Stronzi generates branded visuals for Instagram, coordinated
              ...
              <div className="dark:bg-sand rounded-lg bg-white p-8">
                ...
                <p className="dark:text-text-secondary mb-4 text-sm text-gray-600">
                  Monitor feeds content suggestions into the publishing pipeline
                  based on breaking news detection.
                </p>
                <ul className="dark:text-text-secondary space-y-2 text-sm text-gray-600">
        ...
        <div className="container">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="light:text-gray-600 dark:text-text-secondary mb-8 text-lg">
              I&apos;m always interested in discussing systems design, media
              infrastructure, or potential collaboration.
            </p>
            <div className="flex flex-wrap justify-center gap-6">
              <Link
                to="/contact"
                className="light:bg-sea dark:bg-accent-blue px-8 py-3 font-medium text-white transition-all duration-400"
              >
                Get in Touch
              </Link>
              <Link
                to="/portfolio"
                className="light:border-dusk dark:border-white border px-8 py-3 font-medium transition-all duration-400"
              >
                View Projects
              </Link>
            </div>
