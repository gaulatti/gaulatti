    ...
    <div className='flex flex-col pt-24'>
      <section className='relative py-16'>
        <div className='container'>
          <div className='mx-auto max-w-4xl'>
            ...
            <h1 className='mb-6 text-4xl font-semibold leading-[1.08] tracking-refined md:text-5xl'>fifthbell Media Systems</h1>
            <p className='font-secondary text-text-secondary max-w-3xl text-xl'>
      ...
      <section className='quiet-section py-16'>
        <div className='container'>
          <div className='mx-auto max-w-5xl'>
            <div className='mb-12'>
              <h2 className='mb-4 text-2xl font-semibold tracking-refined md:text-3xl'>fifthbell Media Systems</h2>
            ...
            <div className='dark:bg-sand mb-12 rounded-lg bg-white p-8'>
              <h3 className='mb-6 text-xl font-semibold'>System Architecture</h3>
              <div className='rounded border-2 border-dashed border-gray-300 p-8 text-center dark:border-gray-600'>
                <p className='font-secondary text-text-secondary mb-4 text-gray-500'>Architecture Diagram</p>
            ...
            <div className='grid gap-8 md:grid-cols-2'>
              <div className='content-surface p-8'>
                ...
                <h3 className='mb-2 text-xl font-medium tracking-refined md:text-2xl'>Cronkite</h3>
              ...
              <div className='content-surface p-8'>
                ...
                <h3 className='mb-2 text-xl font-medium tracking-refined md:text-2xl'>Alcántara</h3>
              ...
              <div className='content-surface p-8'>
                <div className='bg-accent-red mb-6 h-1 w-16' />
                <h3 className='mb-2 text-xl font-medium tracking-refined md:text-2xl'>Monitor</h3>
              ...
              <div className='content-surface p-8'>
                <div className='bg-accent-yellow mb-6 h-1 w-16' />
                <h3 className='mb-2 text-xl font-medium tracking-refined md:text-2xl'>Celesti</h3>
      ...
      <section className='py-16'>
        <div className='container'>
          <div className='mx-auto max-w-5xl'>
            <div className='mb-12'>
              <h2 className='mb-4 text-2xl font-semibold tracking-refined md:text-3xl'>Broadcast Stack</h2>
              <p className='font-secondary text-text-secondary max-w-3xl text-lg'>
            ...
            <div className='dark:bg-sand mb-8 rounded-lg bg-white p-8'>
              <h3 className='mb-6 text-xl font-semibold'>Signal Flow</h3>
            ...
            <div className='grid gap-8 md:grid-cols-3'>
              <div className='content-surface p-6 text-center'>
                <div className='text-sea dark:text-accent-blue mb-2 text-4xl font-semibold'>4-5h</div>
                <p className='font-secondary text-text-secondary'>Broadcast Duration</p>
              </div>
              <div className='content-surface p-6 text-center'>
                <div className='text-sea dark:text-accent-blue mb-2 text-4xl font-semibold'>~2000</div>
                <p className='font-secondary text-text-secondary'>P90 Concurrent Viewers</p>
              </div>
              <div className='content-surface p-6 text-center'>
                <div className='text-sea dark:text-accent-blue mb-2 text-4xl font-semibold'>3+</div>
                <p className='font-secondary text-text-secondary'>Distributed Hosts</p>
              </div>
            </div>

            <div className='dark:bg-sand mt-8 rounded-lg bg-gray-50 p-6'>
              <h4 className='mb-3 font-semibold'>Production Details</h4>
              <ul className='font-secondary text-text-secondary space-y-2 text-sm text-gray-600'>
      ...
      <section className='quiet-section py-16'>
        <div className='container'>
          <div className='mx-auto max-w-5xl'>
            <div className='mb-12'>
              <h2 className='mb-4 text-2xl font-semibold tracking-refined md:text-3xl'>Publishing Pipeline</h2>
              <p className='font-secondary text-text-secondary max-w-3xl text-lg'>
            ...
            <div className='grid gap-8 md:grid-cols-2'>
              <div className='content-surface p-8'>
                <h3 className='mb-4 text-xl font-semibold'>Static Publishing</h3>
                <p className='font-secondary text-text-secondary mb-4 text-sm text-gray-600'>
              ...
              <div className='content-surface p-8'>
                <h3 className='mb-4 text-xl font-semibold'>Video Automation</h3>
                <p className='font-secondary text-text-secondary mb-4 text-sm text-gray-600'>
              ...
              <div className='content-surface p-8'>
                <h3 className='mb-4 text-xl font-semibold'>Social Media Automation</h3>
                <p className='font-secondary text-text-secondary mb-4 text-sm text-gray-600'>
              ...
              <div className='content-surface p-8'>
                <h3 className='mb-4 text-xl font-semibold'>Intelligence Layer</h3>
                <p className='font-secondary text-text-secondary mb-4 text-sm text-gray-600'>
      ...
      <section className='py-16'>
        <div className='container'>
          <div className='mx-auto max-w-4xl text-center'>
            <h2 className='mb-6 text-2xl font-semibold tracking-refined md:text-3xl'>Want to discuss architecture?</h2>
            <p className='font-secondary text-text-secondary mb-8 text-lg'>
              I&apos;m always interested in discussing systems design, media infrastructure, or potential collaboration.
            </p>
            <div className='flex flex-wrap justify-center gap-6'>
              <Link
                to='/contact'
                className='light:bg-sea dark:bg-accent-blue px-8 py-3 font-medium text-white transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--motion-surface)] ease-premium'
              >
                Get in Touch
              </Link>
              <Link
                to='/success-cases/sanremo'
                className='light:border-dusk dark:border-white border px-8 py-3 font-medium transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--motion-surface)] ease-premium'
              >
