...
const defaultTitle =
  "Javier Godoy — Staff Software Engineer | Media Infrastructure & Real-Time Systems";
...
const gaTrackingId =
  ...
  ((import.meta.env as Record<string, string | undefined>).PUBLIC_GA_TRACKING_ID ??
    "");

export const meta: Route.MetaFunction = () => [
  { title: defaultTitle },
  { name: "description", content: defaultDescription },
  { name: "author", content: "Javier Godoy" },
  {
    name: "keywords",
    content:
